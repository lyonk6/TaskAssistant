...
public enum Error{
    ...
    PARSE_INTEGER_ARRAY_ERROR(1011),
    DESERIALIZATION_JSON_SYNTAX_ERROR(1012),
    DESERIALIZATION_NOT_A_NUMBER_ERROR(1013),
    DESERIALIZATION_NULL_VALUE_ERROR(1014),
    DECRYPTION_FAILURE_ERROR(1015),
    /* model errors */
    INVALID_NAME_ERROR(1160),
    INVALID_ID_ERROR(1161),
    INVALID_TASK_STATUS_ERROR(1162),
    INVALID_SCHEDULE_REPEAT_TYPE_ERROR(1163),
