 ...
 * @author kennethlyon
 */
public class ValidateUserTest extends UnitTestHelper {
    private Logger LOGGER = LoggerFactory.getLogger(AuthRequestHandlerTest.class);
    ...
    public void setUp() throws Exception {
        ...
        modelRepository=validateUserInstance.getModelRepository();
